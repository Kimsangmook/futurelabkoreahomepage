...
export default function VisionSection() {
  return (
    <section className="w-full bg-white">
      <div className="container mx-auto px-5 space-y-0">
        {/* Challenge Section */}
        <div className="flex flex-col md:flex-row items-center md:space-x-12 h-[231px]">
          {/* Image (left) */}
          <div className="md:w-1/2 relative h-full">
            ...
            />
            {/* Gradient fade on right side of image */}
            <div className="absolute top-0 right-0 h-full w-1/2 bg-gradient-to-r from-transparent to-white" />
          </div>
          {/* Text (right) */}
          <div className="md:w-1/2 h-full flex items-center justify-end px-12">
            <div>
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12 h-[231px]">
          {/* Text (left) */}
          <div className="md:w-1/2 h-full flex items-center justify-start px-12">
            <div>
